...
%
% This configuration will be a long rectangular block. The beam will bend due to gravity 
clear, close
tic;
...
Solver.domain.Ny = 3; Ny = Solver.domain.Ny; % 150 corresponds to 89400 mps and takes ~90s/shape function refresh, compared to Ny=15, this appears to show p_a(x_p) computation scales almost linearly with mps
...
% LME parameters
Solver.LMEParam.gamma = 4; % Nondimensional spacing parameter
...
% Parameters
Solver.Material.dens0 = 1000; rho = Solver.Material.dens0; % nominal material density [kg/m^3]
Solver.Material.E = 1.4*10^7; E = Solver.Material.E; % Young's Modulus [Pa]
